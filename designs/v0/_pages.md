...
|---------|-------|---------|----------|--------|-------|
| project_home | 项目与规范包 | done | yes | yes | 2026-08-27 design profile + page recipe |
| template_annotate | 模板标注 | done | yes | yes | 2026-08-27 design profile + page recipe |
...
| pending_review | 待审工作台 | done | yes | yes | 2026-08-27 design profile + page recipe |
